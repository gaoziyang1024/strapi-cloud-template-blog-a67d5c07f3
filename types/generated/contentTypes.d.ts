...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutDwnUrl: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    ConstitutionDownloadUrl: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    MembershipDownloadUrl: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['Summit 2024', 'Awards & Competitions', 'Past Events']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiFriendLinkFriendLink extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    linksName: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    linksNameEn: Schema.Attribute.Text;
    linksUrl: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    footer: Schema.Attribute.Component<'common.footer-settings', false>;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    banner: Schema.Attribute.DynamicZone<['shared.slider']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ExploreBySector: Schema.Attribute.DynamicZone<
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['White Papers', 'Technical Reports', 'Case Studies']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
